...
export const CoinbaseIcon = ({ className }: BrandIconProps) => (
    <svg aria-label="Coinbase logo" className={className!} height="32" role="img" viewBox="0 0 48 48" width="32" xmlns="http://www.w3.org/2000/svg">
